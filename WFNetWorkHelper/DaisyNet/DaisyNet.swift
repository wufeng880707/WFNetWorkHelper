...
public func upload(
    ...
    return UploadManager.default.upload(url, method: method, parameters: parameters, image: image, encoding: encoding, headers: headers, fileName: fileName)
}

/// 取消上传
///
/// - Parameter url: url
public func uploadCancel(_ url: String, parameters: Parameters? = nil) {
    
    UploadManager.default.cancel(url, parameters:parameters)
}
